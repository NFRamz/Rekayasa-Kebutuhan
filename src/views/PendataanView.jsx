          ...
          <div className="relative">
            ...
            <input 
              ...
              onChange={e => {
                ...
                // Jika user mengetik ulang, reset lat lng agar mereka wajib memilih dari dropdown lagi
                if (formData.lat || formData.lng) {
                  setFormData({...formData, alamat: '', lat: null, lng: null});
                }
              }} 
              onFocus={() => { if (suggestions.length > 0) setShowDropdown(true); }}
              onBlur={() => setTimeout(() => setShowDropdown(false), 200)} // Delay sedikit agar onClick di dropdown bisa jalan
